...
article on Maternal Factors for Low Birth Weight Babies (found here:
<https://pmc.ncbi.nlm.nih.gov/articles/PMC4921448/>) hypothesized that
birthweight is affected by the following factors of interest that are
...
The article also noted that bad obstetric history, pre eclampsia, fetal
distress, and mode of deliveries were studied, but we will focus on the
ones listed above as they are available in our dataset.
